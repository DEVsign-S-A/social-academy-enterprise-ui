          ...
          <div className="rounded-lg bg-gray-100 mt-10 mx-6 pb-8 shadow-xl ring-1 ring-gray-300">
            ...
            >
              ...
              <div className="my-2 py-2">
                ...
                <textarea
                  className="mx-8 w-11/12 bg-gray-100 ring-1 ring-gray-300 rounded-xl py-2 outline-none px-5 font-Poppins text-gray-700 h-24 resize-none"
                  required={true}
                ></textarea>
              </div>
              <div className="my-2 py-2">
                ...
                <textarea
                  className="mx-8 w-11/12 bg-gray-100 ring-1 ring-gray-300 rounded-xl py-2 outline-none px-5 font-Poppins text-gray-700 h-36 resize-none"
                  required={true}
                ></textarea>
              </div>
              <div className="my-2 py-2">
                ...
                <p className="text-gray-400 font-Poppins font-light ml-6 pb-2">
                  Añade las Habilidades necesarias e indispinsables para desempeñar la labor en cuestion
                </p>
                <input
                  required={true}
                  className="mx-8 w-11/12 bg-gray-100 ring-1 ring-gray-300 rounded-lg py-2 outline-none px-4 font-Poppins text-gray-700"
