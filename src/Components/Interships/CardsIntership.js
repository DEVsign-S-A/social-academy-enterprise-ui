...
import { startDeleteInterships } from "../../Redux/Actions/intershipsActions";
...
export const CardsIntership = ({
	...
	const handleDeleted = () => {
		dispatch(startDeleteInterships(id));
	};
		...
		<>
			<div className="bg-gray-50 mx-3 my-4 w-90 rounded-xl shadow-lg ring-1 ring-gray-200">
				<div className="m-3">
					...
					<div className="flex">
						<button
							className="flex font-Poppins text-sm bg-second text-white shadow-lg cursor-pointer px-3 py-2 rounded-lg mx-3 justify-center items-center"
